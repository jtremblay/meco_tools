...
generateOTUTableRrna <- function(gene_abun_filename, taxonomy_filename, outfile) {
...
usage=function(errM) {
  cat("\nUsage : Rscript generateOTUTable.R .R [option] <Value>\n")
...
generateOTUTableRrna(gene_abun, taxonomy, outfile)
