...
class Samples:
    ...
    @staticmethod
    def __get_files_to_download(myAPI, projectId, sampleId, sampleName, sampleLimit=4096, sampleFileLmit=4096):
        sampleToFiles = {}
    ...
    @staticmethod
    def download(clientKey=None, clientSecret=None, accessToken=None, sampleId=None, projectId=None, sampleName=None, projectName=None, outputDirectory='\.', createBsDir=True, url=None):
        '''
        ...
        '''
        appSessionId = ''
        #apiServer = 'https://api.cac1.sh.basespace.illumina.com/' # or 'https://api.cloud-hoth.illumina.com/' https://api.cac1.sh.basespace.illumina.com/
        apiServer = url
        apiVersion = 'v1pre3'
        projectLimit = 100         
        sampleLimit = 1024         
...
if __name__ == '__main__':
    ...
    group.add_option('-U', '--URL-API', help='the basespace illumina url. canada: https://api.cac1.sh.basespace.illumina.com/    USA: https://api.basespace.illumina.com/', dest='url', default=None)
    ...
    Samples.download(options.clientKey, options.clientSecret, options.accessToken, \
            ...
            outputDirectory=options.outputDirectory, createBsDir=options.createBsDir, url=options.url)
