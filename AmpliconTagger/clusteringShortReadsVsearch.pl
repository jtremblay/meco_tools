...
--second_round <float>  : Second round of clustering id (default = 0.97)
...
my ($help, $infile_fastq, $infile_fasta, $ref_db, $start_at, $verbose, $outdir, $barcodes, $num_threads, $lowAbunCutOff, $first_round, $second_round);
GetOptions(
...
$cmd = $vsearch;
$cmd .= " --uchime_ref ".$outdir."/derep1_".$fr."_derep2_nonChimDeNovo.fasta";
$cmd .= " --db ".$ref_db;
#$cmd .= " -strand both";
$cmd .= " --nonchimeras ".$outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef.fasta";
$cmd .= " --threads ".$num_threads;
print STDERR $cmd."\n" if($start_at <= 6);
...
## Sort by size
$cmd = $dereplicate;
$cmd .= " -fasta ".$outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef.fasta";
$cmd .= " -outfile ".$outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef_sorted.fasta";
$cmd .= " -sort";
print STDERR $cmd."\n" if($start_at <= 7);
...
## Cluster at 97%
$cmd = $vsearch." --cluster_smallmem";
$cmd .= " ".$outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef_sorted.fasta";
$cmd .= " --id ".$second_round;
$cmd .= " --log ".$outdir."/derep1_".$fr."_derep2_nonChimDenovoRef_sorted_".$sr.".log";
$cmd .= " --uc ".$outdir."/derep1_".$fr."_derep2_nonChimDenovoRef_sorted_".$sr.".uc";
$cmd .= " --usersort";
$cmd .= " --threads ".$num_threads;
print STDERR $cmd."\n" if($start_at <= 8);
...
## Parse Uclust file and write clusters
uclustToFasta(
  $outdir."/derep1_".$fr."_derep2_nonChimDenovoRef_sorted_".$sr.".uc",   # UC file 
  $outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef_sorted.fasta",        # Ref file
  $outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef_sorted_".$sr.".fasta" # new file
) if($start_at <= 9);
print STDERR "Converting vsearch output to fasta\n" if($start_at <= 9);

## Sort by size
$cmd = $dereplicate;
$cmd .= " --fasta ".$outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef_sorted_".$sr.".fasta";
$cmd .= " --outfile ".$outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef_sorted_".$sr."_sorted.fasta";
$cmd .= " --sort";
print STDERR $cmd."\n" if($start_at <= 10);
...
## Generate Obs table
writeClusters($outdir."/derep1_".$fr."_derep2_nonChimDeNovoRef_sorted_".$sr."_sorted.fasta", $outdir."/obs.tsv", $outdir."/obs.fasta");
