...
PURPOSE:
Takes Ray output directory/Contigs.fasta in input and generates some metrics.

INPUT:
--infile <string>   : Path to your ray assemblies.
...
my @fastaSeqsContigs = $infile;
printStats(\@fastaSeqsContigs, "contigs");
#printStats(\@fastaSeqsScaffolds, "scaffolds");
...
sub printStats{
  ...
  my @seqArray = @$refArray;
   ...
   foreach my $contigs (@seqArray){
     ...
     print STDOUT "\"Assembly stats\"\t\"".($contigs)."\"\n";   
     print STDOUT "\"$prefix greater than 0.5kb\"\t\"".$ge05Kb."\"\n";
     print STDOUT "\"$prefix greater than 1kb\"\t\"".$ge1Kb."\"\n";
     print STDOUT "\"$prefix greater than 2kb\"\t\"".$ge2Kb."\"\n";
     print STDOUT "\"$prefix greater than 5kb\"\t\"".$ge5Kb."\"\n";
     print STDOUT "\"$prefix greater than 10kb\"\t\"".$ge10Kb."\"\n";
     print STDOUT "\"$prefix greater than 20kb\"\t\"".$ge20Kb."\"\n";
     print STDOUT "\"$prefix greater than 40kb\"\t\"".$ge40Kb."\"\n";
     print STDOUT "\"$prefix greater than 80kb\"\t\"".$ge80Kb."\"\n";
     print STDOUT "\"$prefix greater than 160kb\"\t\"".$ge160Kb."\"\n";
     print STDOUT "\"$prefix greater than 320kb\"\t\"".$ge320Kb."\"\n";
     print STDOUT "\"$prefix greater than 640kb\"\t\"".$ge640Kb."\"\n";
     print STDOUT "\"$prefix greater than 1Mb\"\t\"".$ge1Mb."\"\n";
     print STDOUT "\"$prefix greater than 2Mb\"\t\"".$ge2Mb."\"\n";
     print STDOUT "\"$prefix greater than 4Mb\"\t\"".$ge4Mb."\"\n";
     print STDOUT "\"$prefix greater than 6Mb\"\t\"".$ge6Mb."\"\n";
     print STDOUT "\"$prefix greater than 8Mb\"\t\"".$ge8Mb."\"\n";
     print STDOUT "\"$prefix greater than 10Mb\"\t\"".$ge10Mb."\"\n";
   
     print STDOUT "\"Total $prefix\"\t\"$totalContigs\"\n";
     print STDOUT "\"Total bases in $prefix (bp)\"\t\"$totalBases\"\n";
     print STDOUT "\"Minimum $prefix length (bp)\"\t\"$minContigLength\"\n";
     print STDOUT "\"Maximum $prefix length (bp)\"\t\"$maxContigLength\"\n";
     print STDOUT "\"GC content (%)\"\t\"$gcContent\"\n";
