...
OUTPUT:
STDOUT           : Spreadsheet according to the specs needed by
                   gam-ngs

NOTES:
module load nrc/bamtools/2.3.0 nrc/gcc/4.8.2 nrc/samtools/1.1 nrc/nrc_tools/1.0
